...
class CLEFT:
    ...
    def __init__(self, k, p, one_loop=True, shear=False, cutoff=20, jn=15, N = 4000, threads=1, extrap_min = -6, extrap_max = 3, import_wisdom=False, wisdom_file='./zelda_wisdom.npy'):
